...
# En producción Railway pone SECRET_KEY como variable de entorno.
# En local usa el valor por defecto para que siga funcionando.
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure--8ku3fscj+bj(@qgb31v-f-nnifc&pov0y%kvklq@(g43$#^q0'
)
